	      ...
	      <FONT size="2">{$form.username.label}：</FONT></TD>
              <TD width="79%"> 
                {if $form.username.error }
                  <font size="2" color="red">{$form.username.error}</font><BR>
                {/if}
	      ...
	      <FONT size="2">{$form.password.label}：</FONT></TD>
              <TD width="79%"> 
                {if $form.password.error }
                  <font size="2" color="red">{$form.password.error}</font><BR>
                {/if}
            ...
            <TR valign="top"> 
              ...
              <TD width="79%"> 
                {if $form.last_name.error }
                  <font size="2" color="red">{$form.last_name.error}</font><BR>
                {/if}
            ...
            <TR valign="top"> 
              ...
              <TD width="79%"> 
                {if $form.first_name.error }
                  <font size="2" color="red">{$form.first_name.error}</font><BR>
                {/if}
            ...
            <TR valign="top"> 
              ...
              <TD width="79%"> 
                {if $form.birthday.error }
                  <font size="2" color="red">{$form.birthday.error}</font><BR>
                {/if}
                {$form.birthday.html}</TD>
            </TR>
            <TR valign="top"> 
              <TD nowrap align="right" width="150">
              <FONT size="2">{$form.ken.label}：</FONT></TD>
              <TD width="79%"> 
                {if $form.ken.error }
                  <font size="2" color="red">{$form.ken.error}</font><BR>
                {/if}
                {$form.ken.html}</TD>
            </TR>
